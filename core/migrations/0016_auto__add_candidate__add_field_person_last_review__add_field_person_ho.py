...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_candidate', (
            ...
            ('division', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('cv', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('interview', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ...
            ('person', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Person'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['Candidate'])

        # Adding field 'Person.last_review'
        db.add_column(u'core_person', 'last_review',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.hospital'
        db.add_column(u'core_person', 'hospital',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Person.last_review'
        db.delete_column(u'core_person', 'last_review')

        # Deleting field 'Person.hospital'
        db.delete_column(u'core_person', 'hospital')
    ...
    models = {
        ...
        u'core.candidate': {
            ...
            'division': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
