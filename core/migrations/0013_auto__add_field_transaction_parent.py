...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.parent'
        db.add_column(u'core_transaction', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Transaction'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.parent'
        db.delete_column(u'core_transaction', 'parent_id')
    ...
    models = {
        ...
        u'core.transaction': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Transaction']", 'null': 'True', 'blank': 'True'}),
