...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_transaction', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.currency'
        db.delete_column(u'core_transaction', 'currency_id')
