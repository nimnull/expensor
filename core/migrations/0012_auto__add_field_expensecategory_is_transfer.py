...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpenseCategory.is_transfer'
        db.add_column(u'core_expensecategory', 'is_transfer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExpenseCategory.is_transfer'
        db.delete_column(u'core_expensecategory', 'is_transfer')
