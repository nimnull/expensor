...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Candidate.status'
        db.alter_column(u'core_candidate', 'status', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Candidate.division'
        db.alter_column(u'core_candidate', 'division', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Candidate.status'
        db.alter_column(u'core_candidate', 'status', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Candidate.division'
        db.alter_column(u'core_candidate', 'division', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
