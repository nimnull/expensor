...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.person'
        db.add_column(u'core_transaction', 'person',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Transaction.dst_ct'
        raise RuntimeError("Cannot reverse this migration. 'Transaction.dst_ct' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Transaction.dst_id'
        raise RuntimeError("Cannot reverse this migration. 'Transaction.dst_id' and its values cannot be restored.")
        # Deleting field 'Transaction.person'
        db.delete_column(u'core_transaction', 'person_id')
